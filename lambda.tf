locals {
  ...
  lambda_delta_filename = "${abspath(path.module)}/lambda-${var.lambda_name}-delta.zip"
  lambda_build_path     = "${abspath(path.module)}/lambda-${var.lambda_name}-build"
  lambda_filename       = "${abspath(path.module)}/lambda-${var.lambda_name}.zip"
}
